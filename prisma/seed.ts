...
async function main() {
  ...
  const products = [
    ...
    // ── КОНТЕЙНЕРИ ──
    {
      name: 'Astra Контейнери',
      slug: 'astra-filing-cabinet',
      sku: '106001',
      price: 590,
      originalPrice: null,
      description: 'Контейнери от бяло МДФ. Две нива, А4 формат, заключване.',
    ...
    {
      name: 'Terra Контейнери',
      slug: 'terra-filing-cabinet',
      sku: '206001',
      price: 690,
      originalPrice: null,
      description: 'Контейнери на две нива. Светла бреза, А4 формат.',
    ...
    {
      name: 'Loft Контейнери',
      slug: 'loft-filing-cabinet',
      sku: '406001',
      price: 780,
      originalPrice: null,
      description: 'Метален контейнер с дъбов плот. Три нива, индустриален вид.',
    ...
    {
      name: 'Nova Контейнери',
      slug: 'nova-filing-cabinet',
      sku: '306001',
      price: 1380,
      originalPrice: null,
      description: 'Контейнери от орех. Три нива, А4 формат, ключалка.',
