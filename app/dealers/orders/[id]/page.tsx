  ...
  return (
    <>
      ...
      <div className="dl-page">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 24, marginBottom: 24, flexWrap: 'wrap' }}>
            ...
            <tbody>
              {order.items.map(item => (
                <tr key={item.id}>
                  ...
                  <td style={{ textAlign: 'right', fontWeight: 700, color: '#F59E0B' }}>{fmt(item.unitPrice)} лв.</td>
