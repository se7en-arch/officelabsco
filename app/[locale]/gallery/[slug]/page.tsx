...
const series: Record<string, SeriesData> = {
  ...
  loft: {
    ...
    features: [
      ...
      { image: '/products/loft-coffee-table-black-1.png', headline: 'Плот, който не крие конструкцията си', text: 'Металната рамка на кафе масата LOFT остава на показ — практична повърхност с категоричен индустриален характер.' },
      ...
      { image: '/products/loft-high-cab-black-1.png', headline: 'Височина с индустриален характер', text: 'Плътен корпус и категорична визия — високият шкаф LOFT организира пространството, без да омекотява тона на серията.' },
      ...
      { image: '/products/loft-plant-black-1.png', headline: 'Зеленото, поставено в суров контекст', text: 'Дори растенията в LOFT намират място в категорична, индустриална конструкция.' },
