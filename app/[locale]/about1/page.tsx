...
export const metadata: Metadata = {
  ...
  description: 'Не произвеждаме мебели за масовия пазар. Произвеждаме мебели за хора, наясно, че качеството не е лукс — то е решение.',
};

export default async function About1Page() {
  const t = await getTranslations('about1');
